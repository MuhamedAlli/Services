...
{
    /// <inheritdoc />
    public partial class CreateDatabaseAndCreateTables : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Satet = table.Column<int>(type: "int", nullable: false),
                    IsAvailable = table.Column<bool>(type: "bit", nullable: false),
                    CostHour = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    Balance = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    PendingMoney = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    CompletedTasks = table.Column<int>(type: "int", nullable: false),
                    UnCompletedTasks = table.Column<int>(type: "int", nullable: false),
                    RejectedTasks = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsReaded = table.Column<DateTime>(type: "datetime2", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AcceptedById = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    AcceptedOn = table.Column<DateTime>(type: "datetime2", nullable: false),
                    WorkerRate = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    WorkerComment = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ClientRate = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
