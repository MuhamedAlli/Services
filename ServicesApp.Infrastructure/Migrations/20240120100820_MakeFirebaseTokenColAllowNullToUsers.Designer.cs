...
namespace ServicesApp.Infrastructure.Migrations
{
    ...
    [Migration("20240120100820_MakeFirebaseTokenColAllowNullToUsers")]
    partial class MakeFirebaseTokenColAllowNullToUsers
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ServicesApp.Domain.Entities.Order", b =>
                {
                    ...
                    b.Property<decimal>("MaterialsPrice")
                        .HasColumnType("decimal(18,2)");
            ...
            modelBuilder.Entity("ServicesApp.Domain.Entities.Order", b =>
                {
                    b.HasOne("ServicesApp.Domain.Entities.ApplicationUser", "ProvidedBy")
                        .WithMany()
